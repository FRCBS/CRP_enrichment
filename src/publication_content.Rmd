...
```{r}
# TODO: del
u40 <- fer_crp %>% filter(Group == "Women|Menstr" & Ferritin < 40 & Cohort == "H2000")
o40 <- fer_crp %>% filter(Group == "Women|Menstr" & Ferritin >= 40 & Cohort == "H2000")
u40_OC <- fer_crp_omit_OC %>% filter(Group == "Women|Menstr" & Ferritin < 40 & Cohort == "H2000")
o40_OC <- fer_crp_omit_OC %>% filter(Group == "Women|Menstr" & Ferritin >= 40 & Cohort == "H2000")
CRP_OC_comparison <- bind_rows(u40, o40, u40_OC, o40_OC) %>% mutate(label = c(rep("u40", nrow(u40)),
                                                                              rep("o40", nrow(o40)),
                                                                              rep("u40_OC", nrow(u40_OC)),
                                                                              rep("o40_OC", nrow(o40_OC))))
...
insulin_xcl_women_mens <- excl_fr_women_mens$dataset %>% filter(Group == "Women|Menstr") %>% filter(Q38 == 2 | Q38 == 4) %>% nrow()
insulin_xcl_women_nonmens <- excl_fr_women_nonmens$dataset %>% filter(Group == "Women|Non-menstr") %>% filter(Q38 == 2 | Q38 == 4) %>% nrow()
insulin_xcl_men <- excl_fr_men$dataset %>% filter(Group == "Men") %>% filter(Q38 == 2 | Q38 == 4) %>% nrow()
```
...
```{r}
ratio1 <- round(nrow(fer_crp_hormonal %>% filter(Hormonal == "No" & Cohort == "FR97", CRP >= 3 & Ferritin >= 15)) * 100 / nrow(fer_crp_hormonal %>% filter(Hormonal == "No" & Cohort == "FR97")), 2)
ratio2 <- round(nrow(fer_crp_hormonal %>% filter(Hormonal == "Yes" & Cohort == "FR97", CRP >= 3 & Ferritin >= 15)) * 100 / nrow(fer_crp_hormonal %>% filter(Hormonal == "Yes" & Cohort == "FR97")), 2)
ratio3 <- round(nrow(fer_crp_hormonal %>% filter(Hormonal == "Men" & Cohort == "FR97", CRP >= 3 & Ferritin >= 15)) * 100 / nrow(fer_crp_hormonal %>% filter(Hormonal == "Men" & Cohort == "FR97")), 2)
ratio4 <- round(nrow(fer_crp_hormonal %>% filter(Hormonal == "No" & Cohort == "H2000", CRP >= 3 & Ferritin >= 15)) * 100 / nrow(fer_crp_hormonal %>% filter(Hormonal == "No" & Cohort == "H2000")), 2)
ratio5 <- round(nrow(fer_crp_hormonal %>% filter(Hormonal == "Yes" & Cohort == "H2000", CRP >= 3 & Ferritin >= 15)) * 100 / nrow(fer_crp_hormonal %>% filter(Hormonal == "Yes" & Cohort == "H2000")), 2)
ratio6 <- round(nrow(fer_crp_hormonal %>% filter(Hormonal == "Men" & Cohort == "H2000", CRP >= 3 & Ferritin >= 15)) * 100 / nrow(fer_crp_hormonal %>% filter(Hormonal == "Men" & Cohort == "H2000")), 2)
ann_text <- data.frame(Ferritin = rep(900, 6), CRP = rep(50, 6), lab = c(paste0(ratio1, "%"), paste0(ratio2, "%"), paste0(ratio3, "%"), paste0(ratio4, "%"), paste0(ratio5, "%"), paste0(ratio6, "%")), Cohort = c(rep("FR97", 3), rep("H2000", 3)), Hormonal = rep(c("No", "Yes", "Men"), 2))
p <- ggplot(data = fer_crp_hormonal, aes(x = Ferritin, y = CRP)) + 
    annotate("rect", xmin = 15, xmax = 2000, ymin = 3, ymax = 200, alpha = .5, fill = "grey") +
    geom_text(data = ann_text, aes(label = lab)) +
    geom_point(alpha = 0.1) +
    scale_x_log10() +
    ...
    geom_smooth(method = "lm", formula = y ~ x, color = "black", linetype = "dashed", size = 0.5) +
    stat_cor(aes(label = paste(..rr.label.., ..p.label.., sep = "~`,`~")), p.accuracy = 0.001) +
    facet_grid(rows = vars(Hormonal), cols = vars(Cohort)) +
    labs(x = expression(paste("Ferritin (", mu, "g/l)")), 
         y = "CRP (mg/l)") + 
    theme(text = element_text(size = 15))
...
fer_crp$recoded <- recode_factor(fer_crp$Group, "Women|Menstr" = "Women\nMenstr", "Women|Non-menstr" = "Women\nNon-menstr")
options(scipen = 10000)
ratio1 <- round(nrow(fer_crp %>% filter(Group == "Women|Menstr" & Cohort == "FR97", CRP >= 3 & Ferritin >= 15)) * 100 / nrow(fer_crp %>% filter(Group == "Women|Menstr" & Cohort == "FR97")), 2)
ratio2 <- round(nrow(fer_crp %>% filter(Group == "Women|Non-menstr" & Cohort == "FR97", CRP >= 3 & Ferritin >= 15)) * 100 / nrow(fer_crp %>% filter(Group == "Women|Non-menstr" & Cohort == "FR97")), 2)
ratio3 <- round(nrow(fer_crp %>% filter(Group == "Men" & Cohort == "FR97", CRP >= 3 & Ferritin >= 15)) * 100 / nrow(fer_crp %>% filter(Group == "Men" & Cohort == "FR97")), 2)
...
ratio5 <- round(nrow(fer_crp %>% filter(Group == "Women|Non-menstr" & Cohort == "H2000", CRP >= 3 & Ferritin >= 15)) * 100 / nrow(fer_crp %>% filter(Group == "Women|Non-menstr" & Cohort == "H2000")), 2)
ratio6 <- round(nrow(fer_crp %>% filter(Group == "Men" & Cohort == "H2000", CRP >= 3 & Ferritin >= 15)) * 100 / nrow(fer_crp %>% filter(Group == "Men" & Cohort == "H2000")), 2)
ann_text <- data.frame(Ferritin = rep(900, 6), CRP = rep(50, 6), lab = c(paste0(ratio1, "%"), paste0(ratio2, "%"), paste0(ratio3, "%"), paste0(ratio4, "%"), paste0(ratio5, "%"), paste0(ratio6, "%")), Cohort = c(rep("FR97", 3), rep("H2000", 3)), recoded = rep(c("Women\nMenstr", "Women\nNon-menstr", "Men"), 2))
p <- ggplot(data = fer_crp %>% filter(Cohort == "H2000" & Group == "Women|Menstr"), aes(x = Ferritin, y = CRP)) + 
    annotate("rect", xmin = 15, xmax = 2000, ymin = 3, ymax = 200, alpha = .5, fill = "grey") +
    geom_text(data = ann_text[4, ], aes(label = lab), size = 12) +
    geom_point(aes(color = recoded), alpha = 0.9) +
    scale_x_log10() +
    scale_y_log10() +
    ...
    stat_cor(aes(label = paste(..rr.label.., ..p.label.., sep = "~`,`~")), p.accuracy = 0.001, size = 12) +
    #facet_grid(rows = vars(recoded), cols = vars(Cohort)) +
    theme(legend.position = "none") +
    labs(x = expression(paste("Ferritin (", mu, "g/l)")), 
         y = "CRP (mg/l)") + 
    theme(text = element_text(size = 30))
# Save
# svg("~/CRP_enrichment/results/scatterplot_separated_colored_rescaled.svg",
#     width = 7,
#     height = 4.9,
#     bg = "transparent")
# p
...
png("~/CRP_enrichment/results/scatterplot_women_menstr.png",
    width = 800,
    height = 420)
p
dev.off() -> . # so we avoid output
...
## ORAL CONTRACEPTION INSERT

Might want to reorganize this bit later
...
# FINRISK
# Menstruating Women
frwomenpre5 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Women|Menstr" & Ferritin == 5)
frwomenpre15 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Women|Menstr" & Ferritin == 15)
frwomenpre30 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Women|Menstr" & Ferritin == 30)
frwomenpre50 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Women|Menstr" & Ferritin == 50)

# Non-menstruating Women
frwomenpost5 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Women|Non-menstr" & Ferritin == 5)
frwomenpost15 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Women|Non-menstr" & Ferritin == 15)
frwomenpost30 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Women|Non-menstr" & Ferritin == 30)
frwomenpost50 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Women|Non-menstr" & Ferritin == 50)

# Men
frmen5 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Men" & Ferritin == 5)
frmen15 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Men" & Ferritin == 15)
frmen30 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Men" & Ferritin == 30)
frmen50 <- means_all_OC %>% filter(Cohort == "FR97" & Group == "Men" & Ferritin == 50)

# H2K
# Menstruating Women
h2kwomenpre5 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Women|Menstr" & Ferritin == 5)
h2kwomenpre15 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Women|Menstr" & Ferritin == 15)
h2kwomenpre30 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Women|Menstr" & Ferritin == 30)
h2kwomenpre50 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Women|Menstr" & Ferritin == 50)

# Non-menstruating Women
h2kwomenpost5 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Women|Non-menstr" & Ferritin == 5)
h2kwomenpost15 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Women|Non-menstr" & Ferritin == 15)
h2kwomenpost30 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Women|Non-menstr" & Ferritin == 30)
h2kwomenpost50 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Women|Non-menstr" & Ferritin == 50)

# Men
h2kmen5 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Men" & Ferritin == 5)
h2kmen15 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Men" & Ferritin == 15)
h2kmen30 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Men" & Ferritin == 30)
h2kmen50 <- means_all_OC %>% filter(Cohort == "H2000" & Group == "Men" & Ferritin == 50)
...
means_all$recoded <- recode_factor(means_all$Group, "Women|Menstr" = "Women\nMenstr", "Women|Non-menstr" = "Women\nNon-menstr")

p <- ggplot(data = means_all, aes(x = Ferritin, y = means)) +
    geom_ribbon(aes(ymin = lower, ymax = upper, fill = recoded), alpha = .3) +
    geom_line(aes(linetype = recoded)) +
...
# Save
# svg("~/CRP_enrichment/results/ratio_plot_separated_colored_rescaled.svg",
#     width = 7,
#     height = 4.9,
#     bg = "transparent")
# p
...
png("~/CRP_enrichment/results/ratio_plot_separated_colored_rescaled.png",
    width = 600,
    height = 420)
p
dev.off() -> . # so we avoid output
...
# q <- ggplot(data = means_all %>% filter(Group == "Women|Menstr" & Cohort == "H2000") , aes(x = Ferritin, y = means)) +
#     geom_ribbon(aes(ymin = lower, ymax = upper, fill = recoded), alpha = .3) +
#     geom_line(aes(linetype = recoded), linewidth = 2) +
#     scale_color_manual(values = c( "#495867",  "#BDD358", "#FE5F55" ),
#                        limits = c( "Men",  "Women\nNon-menstr", "Women\nMenstr" )) +
#     scale_fill_manual(values = c( "#495867",  "#BDD358", "#FE5F55" ),
#                       limits = c( "Men",  "Women\nNon-menstr", "Women\nMenstr" )) +
...
# 
# png("~/CRP_enrichment/results/ratio_plot_women_menstr.png",
#     width = 800,
#     height = 420)
# q
# dev.off() -> . # so we avoid output
