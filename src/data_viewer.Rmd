...
multiplot(p1, p2, p3, cols = 1)
```
What happens to CRP when we start filtering donors based on ferritin levels? Let's say (possibly outlandishly) that we want to set the LB of donor ferritin to 100 ug/L. To see the effect, we want to compare the CRP medians/means of population over and under the ferritin LB.
